...
@section('content')
    <div class="max-w-lg mx-auto">
        <section class="hrm-modern-surface rounded-2xl overflow-hidden border" style="border-color: var(--hr-line);">
            ...
            <div class="px-5 py-4 border-b" style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.1) 0%, rgba(5, 150, 105, 0.05) 100%); border-color: var(--hr-line);">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <span class="h-10 w-10 rounded-xl flex items-center justify-center" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
                        ...
                        <div>
                            <h2 class="text-base font-bold" style="color: var(--hr-text-main);">Punch In</h2>
                            <p class="text-xs" style="color: var(--hr-text-muted);">Start your workday</p>
                        </div>
                    </div>
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('modules.attendance.check-in') }}" class="px-5 py-4">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <textarea
                        ...
                        placeholder="Working from home, early start, etc."
                    ></textarea>
                </div>

                <div class="flex items-center gap-2">
                    <button type="submit" class="flex-1 inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold text-white" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
            ...
            <div class="px-5 py-3 border-t" style="background: var(--hr-surface-strong); border-color: var(--hr-line);">
                <p class="text-[11px] leading-relaxed" style="color: var(--hr-text-muted);">
                    Your check-in time will be recorded. Late arrivals may require approval.
                </p>
            </div>
        </section>
    </div>
