...
@section('content')
    ...
    <section class="grid grid-cols-1 xl:grid-cols-3 gap-5">
        ...
        <article class="hrm-modern-surface rounded-2xl p-5 xl:col-span-2">
            ...
            <form method="GET" action="{{ route('modules.holidays.index') }}" class="mt-4 grid grid-cols-1 md:grid-cols-4 gap-3">
                <input type="text" name="q" value="{{ $filters['q'] }}" placeholder="Search holiday name, branch..." class="md:col-span-2 rounded-xl border px-3 py-2.5 bg-transparent" style="border-color: var(--hr-line);">
            ...
            <div class="mt-4 overflow-x-auto">
                <table class="w-full min-w-[840px] text-sm">
                        ...
                        <tr class="border-b" style="border-color: var(--hr-line);">
                            ...
                            <td class="py-2.5 px-2">
                                <div class="flex justify-end items-center gap-2">
                                    <a href="{{ route('modules.holidays.edit', $holiday) }}" class="rounded-lg px-2.5 py-1.5 text-xs font-semibold border" style="border-color: var(--hr-line);">Edit</a>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="py-6 text-center text-sm" style="color: var(--hr-text-muted);">No holidays found for the selected financial year.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
