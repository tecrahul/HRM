    ...
    private function seedCompanySettings(): void
    {
        CompanySetting::query()->updateOrCreate(
            ...
            [
                ...
                'legal_entity_name' => 'HRM Demo Corp LLC',
                'legal_entity_type' => 'llc',
                'registration_number' => 'DE-2024-001',
                ...
                'brand_tagline' => 'People Operations Reimagined',
                ...
                'branch_directory' => [
                    [
                        ...
                        'phone' => '+1-555-0100',
                        'timezone' => 'America/New_York',
                        'address' => '121 Enterprise Ave, New York, NY',
                        'is_primary' => true,
                    ],
                    [
                        'label' => 'London Office',
                        'code' => 'LDN-01',
                        'phone' => '+44 20 1234 4567',
